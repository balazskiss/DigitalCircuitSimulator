...
${OBJECTDIR}/ComponentList.o: ComponentList.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ComponentList.o ComponentList.cpp
...
${OBJECTDIR}/CLI.o: CLI.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/CLI.o CLI.cpp

${OBJECTDIR}/Circuit.o: Circuit.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
